...
const SavedAttractionsScreen = () => {
  ...
  const fetchAttractions = async () => {
    try {
      const response = await axios.post(
        'https://sunbeam-pet-octopus.ngrok-free.app/getAttractions',
        {},
        {
  ...
  const deleteAttraction = async (name) => {
    try {
      const response = await axios.post(
        'https://sunbeam-pet-octopus.ngrok-free.app/deleteAttraction',
        { name },
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>Saved Attractions</Text>
